...
/* ─────────────────────────────────────────
   AUTO-SUM: Total Fab = Work Fab + Plain Fab
───────────────────────────────────────── */
function calcTotalFab(el) {
  var tr = el.closest('tr');
  var inputs = tr.querySelectorAll('input');
  // inputs order: 0=partyName, 1=fabricName, 2=colour, 3=workFab, 4=plainFab, 5=totalFab, 6=receivedFab, 7=workPcs
  var workFab  = parseFloat(inputs[3].value) || 0;
  var plainFab = parseFloat(inputs[4].value) || 0;
  inputs[5].value = (workFab + plainFab) || '';
}
